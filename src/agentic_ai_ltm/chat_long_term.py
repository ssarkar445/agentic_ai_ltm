...
memory_llm = ChatOpenAI(api_key=settings.openai_api_key,model="gpt-4o-mini", temperature=0)
chat_llm = ChatOpenAI(api_key=settings.openai_api_key,model="gpt-4o-mini")
...
DB_URI = "postgresql://postgres:postgres@localhost:5442/memory_chat?sslmode=disable"
user_id = "suman"
